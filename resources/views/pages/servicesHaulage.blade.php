...
@section('title')
	Haulage &amp; Fleet. Tarzan Enterprise Ltd.
@stop

@section('sidebar')
	<img src="{{asset('img/sidebar/trucks.png')}}">
@stop

@section('content')
		<h2>Haulage and Fleet</h2>
        <p>Tarzan has a long history and experience in haulage transport. Our red trucks are recognizable all over Ghana and our name is equivalent to goodwill. Our operations division is staffed with highly seasoned experts that can assist in delivering the quality of transport service that you've come to expect.</p>

		<p><img src ="{{asset('img/haulage_and_fleet.jpg')}}"></p>
